# -*- coding: utf-8 -*-
"""
Created on Fri Jan  8 21:50:52 2021
...
class ConvNet(torch.nn.Module):
    ...
    def __init__(self,CH_1, CH_2, CH_3, CH_4):
        ...
        self.features = nn.Sequential(   
            ...
            # nn.Conv2d(CH_2, CH_2, kernel_size=3, padding=1),
            # nn.ReLU(inplace=True),
            # 28*28*CH_2
            ...
            nn.ReLU(inplace=True),
            # nn.Conv2d(CH_3, CH_3, kernel_size=3, padding=1),
            # nn.ReLU(inplace=True),
            # 14*14*CH_3
            nn.MaxPool2d(kernel_size=2, stride=2),
            # 7*7*CH_3
...
if __name__ == '__main__':
    ...
    if torch.cuda.is_available():
      ...
      train_feature_t = train_feature_t.cuda()
      train_label_t = train_label_t.cuda()
      test_feature_t = test_feature_t.cuda()
      test_label_t = test_label_t.cuda()
